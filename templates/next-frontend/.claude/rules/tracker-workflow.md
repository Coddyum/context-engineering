...
| Production | hosting, environment variables, analytics, rollout | … |
...
- Really finished — delivered, typecheck/lint/tests green, committed on a branch — archive the card. Do
...
- Sections `## Why` and `## Done when` — **checkable criteria** ("`pnpm test` green", "an
